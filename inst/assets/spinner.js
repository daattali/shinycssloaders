...
$(document).on('shiny:recalculating', function(event) {
    ...
    $(".recalculating").siblings(".shiny-spinner-placeholder").siblings('.shiny-bound-output, .shiny-output-error').hide();
});
...
$(document).on('shiny:value shiny:error', function(event) {
    ...
    $("#"+event.target.id).siblings(".shiny-spinner-placeholder").siblings('.shiny-bound-output').show();
});
